...
INSERT INTO Subaxes (axis_id, subaxis_name) VALUES
-- Compétences
(1, 'Excellence Technique/Communauté de pratiques'),
(1, 'Faire agile'),
(1, 'Gestion humaine des compétences'),
-- Réactivité
(2, 'Vélocité de réponse'),
(2, 'Environnements souples'),
(2, 'Défi environnemental'),
(2, 'Veille et benchmark'),
-- Numériques
(3, 'Business model'),
(3, 'Relation client'),
(3, 'Management');
